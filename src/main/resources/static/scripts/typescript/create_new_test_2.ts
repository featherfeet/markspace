...
let selection_active: boolean = false; // This flag indicates when the user is in the act of selecting a region in the canvas (i. e. the "drag" part of the "click-and-drag").
